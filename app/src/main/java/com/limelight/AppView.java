                ...
                if (details.state == ComputerDetails.State.OFFLINE) {
                    ...
                    AppView.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            MoonlightToast.makeText(AppView.this, getResources().getText(R.string.lost_connection), Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                ...
                if (details.state == ComputerDetails.State.ONLINE && details.pairState != PairingManager.PairState.PAIRED) {
                    AppView.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            // Display a toast to the user and quit the activity
                            MoonlightToast.makeText(AppView.this, getResources().getText(R.string.scut_not_paired), Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
        ...
        switch (item.getItemId()) {
            ...
            case CREATE_SHORTCUT_ID:
                ...
                if (!shortcutHelper.createPinnedGameShortcut(computer, app.app, appBits)) {
                    MoonlightToast.makeText(AppView.this, getResources().getString(R.string.unable_to_pin_shortcut), Toast.LENGTH_LONG).show();
                }
                return true;
